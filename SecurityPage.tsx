            ...
            <div className="container mx-auto px-4 py-12">
                ...
                <main className="max-w-4xl mx-auto prose prose-lg prose-invert prose-p:text-[var(--text-secondary)] prose-headings:text-[var(--text-primary)] prose-strong:text-white prose-ul:text-[var(--text-secondary)] prose-li:marker:text-[var(--accent-primary)] prose-code:text-cyan-400 prose-code:before:content-none prose-code:after:content-none prose-blockquote:border-[var(--accent-primary)] prose-blockquote:text-gray-400">
                    ...
                    <ul>
                        ...
                        <li><strong>Armazenamento Seguro:</strong> Suas informações de perfil e histórico de conversas em texto são armazenados no Firestore, um banco de dados do Google, e protegidos por regras de segurança rigorosas que garantem que apenas você possa acessar seus próprios data.</li>
                    ...
                    <ul>
                        <li><strong>Senha Forte:</strong> Use uma senha única e forte para sua conta Denny IA.</li>
                        <li><strong>Consciência de Compartilhamento:</strong> Lembre-se que Denny analisa o que está visível na sua tela. Evite compartilhar telas que contenham informações pessoais sensíveis, como senhas, documentos ou informações financeiras.</li>
